...
import com.xiaoju.basetech.config.JacocoConfig;
...
public class UnitTester {
    ...
    public void executeUnitTest(CoverageReportEntity coverageReport) {
        ...
        String[] cmd = new String[]{unittestCmd + " -Dmaven.test.skip=false " + jacocoConfig.getPrepareAgentCommand() + " "
                + "compile test-compile org.apache.maven.plugins:maven-surefire-plugin:2.22.1:test "
                + "org.apache.maven.plugins:maven-jar-plugin:2.4:jar " + jacocoConfig.getReportCommand() + " -Dmaven.test.failure.ignore=true -Dfile.encoding=UTF-8 "
