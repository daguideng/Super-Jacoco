...
public class Constants {
    ...
    public static String CODE_ROOT = "./app/super_jacoco/clonecode/";
    public static String LOG_PATH = "./report/logs/";
    ...
    public static String JACOCO_RESOURE_PATH = "./resource/jacoco-resources";
