...
### 本人是对Super-Jacoco的开源项目进行修改，站在巨人的肩膀上，必免了重复造轮子，非常感谢Super-Jacoco项目的作者。
### 改动
+ 1、修改JDK版本为21
+ 2、修改Mavan版本为3.9.6
+ 3、修改数据库连接驱动为mysql-connector-java-8.0.33
+ 4、修改gitlab-java-api版本为16.1.0
+ 5、修改jacoco版本为0.8.5
+ 6、修改spring-boot版本为2.7.13
+ 7、修改spring-cloud版本为2022.0.3
+ 8、修改spring-cloud-starter-openfeign版本为2022.0.3
+ 9、修改spring-cloud-starter-loadbalancer版本为2022.0.3
+ 10、修改spring-cloud-starter-netflix-eureka-client版本为2022.0.3
+ 11、支持docker-compose部署
